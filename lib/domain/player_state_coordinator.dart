...
class PlayerStateCoordinator {
    ...
    _infoRepo = songInfoRepo
  {
    ...
    if (kDebugMode) {
      ...
      stateInfoStream.listen((event) => log('PlayerInfoState: {playing: ${event.playing}}, processingState: ${event.processingState.name}, songInfo: {title: ${event.songInfo.title}}, ...}', name: 'Player State Coordinator'));
    }
  }
