...
const double controlIconSize = controlIconBoxSize - 4;
const double menuIconBoxSize = 20;
const double menuIconSize = menuIconBoxSize - 4;
const double windowIconBoxSize = 24;
const double windowIconSize = windowIconBoxSize - 8;
